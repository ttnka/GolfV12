    ...
    public class G520ScoreServ : IG520ScoreServ
    {
        ...
        public async Task<G520Score> AddScore(G520Score score)
        {
            ...
            */
            ...
            { return await newScore.Content.ReadFromJsonAsync<G520Score>(); }
            else
            { return null; }
        }
            ...
            if (!string.IsNullOrEmpty(clave))
            {
                ...
                switch (parametros[0])
                {
                    ...
                    case "sco3tarjeta":
                        ...
                        break;
                    case "sco1player":
                        resultado += "sco1player_-_player_-_" + ScoreDic["player"];
                        break;
                    case "sco2player":
                        resultado += "sco2player_-_player_-_" + ScoreDic["player"] 
                                    + "_-_status_-_true";
                        break;
